...
$learners = [];
$result = $conn->query("SELECT * FROM learners WHERE grade_level = '11' AND status = 'Approved'");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>MACAYO INTEGRATED SCHOOL <small> GRADE 11 Students</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Student</a></li>
        <li class="active">GRADE 11 Students</li>
      </ol>
    </section>
<!-- Trigger Button -->
<!-- Trigger Button -->
