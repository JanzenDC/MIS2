...
$learners = [];
$result = $conn->query("SELECT * FROM learners WHERE grade_level = '9'");
...
<head>
  ...
  <title>Grade 9 Students</title><link rel="icon" href="../img/favicon2.png">
