...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO learners (lrn, fname, lname, dob, gender, studentType, schoolAttended, gradelevel, guardianName, guardianRelationship, guardian, curriculum, sf10FilePath, imageFilePath) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("isssssssssss", $lrn, $fname, $lname, $dob, $gender, $studentType, $schoolAttended, $gradelevel, $guardianName, $guardianRelationship, $guardian, $curriculum, $sf10FilePath, $imageFilePath);
...
<head>
  ...
  <title>Grade 7 Student</title><link rel="icon" href="../img/favicon2.png">
...
<tbody>
        <?php foreach ($learners as $index => $learner): ?>
            <tr>
                ...
                <td class="text-center">
    <?php 
        echo !empty($learner['other_school']) ? $learner['other_school'] : $learner['school_attended']; 
    ?>
</td>
