            ...
            <div class="row">
                <div class="col-xs-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" method="POST" action="add_shs_subjects.php">
                            <div class="box-body">
...
<div class="form-group">
    ...
    <tr>
        ...
        <th>Subject Name</th>
        <th>Description</th>
        <th style="width: 150px;">Actions</th> <!-- Adjust the width as needed -->
    </tr>
</thead>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" action="edit_subject1.php">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" method="POST" action="delete_subject1.php">
