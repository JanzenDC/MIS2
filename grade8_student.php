...
$learners = [];
$result = $conn->query("SELECT * FROM learners WHERE grade_level = '8'");
...
<head>
  ...
  <title>Grade 8 Students</title><link rel="icon" href="../img/favicon2.png">
