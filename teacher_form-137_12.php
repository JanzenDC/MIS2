...
$learners = [];
$result = $conn->query("SELECT * FROM learners WHERE grade_level = '12' AND status = 'Approved'");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>MACAYO INTEGRATED SCHOOL <small> GRADE 12 Students</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Student</a></li>
        <li class="active">GRADE 12 Students</li>
      </ol>
    </section>
<!-- Trigger Button -->
<!-- Trigger Button -->
...
<tbody>
    ...
    <?php echo !empty($learner['other_school']) ? $learner['other_school'] : $learner['school_attended']; ?>
                ...
                <td class="text-center">
                <a href="printable_record_shs.php?lrn=<?= $learner['lrn']; ?>&grade=<?= $learner['grade_level']; ?>" class="btn btn-primary" style="margin-right: 10px;">Printable SF10</a>
