...
<div class="container mt-3 text-center">
  <div class="btn-group" role="group">
    ...
    <!-- Other Buttons -->
    <a href="admission_status.php" class="btn btn-info btn-lg rounded-pill shadow-lg mx-2 btn-effect">Application Status</a>
    <a href="contact_us.html" class="btn btn-success btn-lg rounded-pill shadow-lg mx-2 btn-effect">Contact Us</a>
  </div>
</div>
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
      ...
      <div class="contact-info text-center my-4 p-4 border rounded shadow">
    <p><strong>Address:</strong> Macayo Integrated School, 1234 School Lane, Bayambang, Pangasinan, Philippines</p>
    <p><strong>Phone:</strong> <a href="tel:+631234567890" class="text-decoration-none">+63 123 456 7890</a></p>
    <p><strong>Email:</strong> <a href="mailto:info@macayo.edu.ph" class="text-decoration-none">info@macayo.edu.ph</a></p>
    <p>
        <strong>Follow us:</strong>
        <a href="https://facebook.com/macayo" class="bi bi-facebook mx-2" style="font-size: 1.5rem;" target="_blank" rel="noopener"></a>
        <a href="https://twitter.com/macayo" class="bi bi-twitter mx-2" style="font-size: 1.5rem;" target="_blank" rel="noopener"></a>
        <a href="https://instagram.com/macayo" class="bi bi-instagram mx-2" style="font-size: 1.5rem;" target="_blank" rel="noopener"></a>
    </p>
</div>
